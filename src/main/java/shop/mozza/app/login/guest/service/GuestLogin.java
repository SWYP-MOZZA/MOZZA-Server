...
public class GuestLoginSuccessHandler  {
    ...
    @Override
    public void GuestLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException, IOException {
